 ...
 * CopyIcon Component
 *
 * A reusable SVG component representing a copy icon. It accepts all standard SVG props
 * via the `CopyIconProps` interface and can be customized using these props.
 *
 * @param {CopyIconProps} props - Props passed to the SVG element for customization.
 * @returns {JSX.Element} The CopyIcon SVG component.
 */
function CopyIcon(props: CopyIconProps): JSX.Element {
  return (
    <svg
