...
interface SelectMediaIconProps extends React.SVGProps<SVGSVGElement> {
  width?: number;
  height?: number;
  fill?: string;
}
...
/**
 * SelectMediaIcon Component
 * @description SVG icon for selecting media, supports custom size and color.
 */
...
export default SelectMediaIcon;
